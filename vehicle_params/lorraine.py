...
class Lorraine(BaseVehicle):
    def __init__(self):
        ...
        self.cg_bias = 0.6  # Position of the cg from front to rear, value from 0->1
        self.cg_height = 12.09 * 0.0254 # m 
        self.mass_sprung = 245 # kg
        ...
        self.front_roll_stiffness = 143 * (180/math.pi) / (self.front_track / 2) # N/rad 
        ...
        self.front_static_camber = -2 * (np.pi / 180)
