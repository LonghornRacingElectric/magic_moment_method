...
class Concept2023:
    def __init__(self, motor_directory):
        ...
        self.sprung_inertia = np.array([[119.8, 0, 0], [0, 33.4, 0], [0, 0, 108.2]])  # kg*m^2 # TODO this is incorrect - check solidworks
        self.gravity = 9.81 # m/s^2
        # TODO: make cg bias of car and driver, so driver mass can be swept to see its affect on car performance
        self.cg_bias = (1 - .475) # % rear/total, value from 0->1
        self.cg_left = .495 # % left/total, value from 0->1 # TODO: verify this is right
        self.cg_height = 12 * (0.0254) # m
        self.wheelbase = 61 * (0.0254) # m
        self.front_track = 50 * (0.0254) # m
        self.rear_track = 48 * (0.0254) # m
        self.max_motor_speed = 4158 * (2 * np.pi / 60) # rad/s
        ...
        # TODO: not sure if antidive is even being used right now
        ...
        # ~~~ Linkages & HDPTs ~~~ #
        self.rear_toe = 1 * (math.pi / 180) # rad
        self.front_toe = 0 * (math.pi / 180) # rad
        self.front_static_camber = -1 * (np.pi / 180) # rad
        self.rear_static_camber = -1 * (np.pi / 180) # rad
        ...
        # TODO: implement rear toe gain and roll center heights & migration
        # self.rear_toe_gain = 0.18 * (np.pi / 180) # rad/rad
        # self.front_roll_center_height = -.75 * .0254 # m
        # self.rear_roll_center_height = -.5 * .0254 # m
        ...
        self.front_tire_mu_scaling = 0.57 # %
        self.rear_tire_mu_scaling = 0.57 # %
        ...
        self.motor_radius = 1 # m
        self.diff_radius = 3.38 # m
        self.front_tire_radius = 8 * .0254 # TODO: effective radius
        self.rear_tire_radius = 9 * .0254 # TODO: effective radius
        # TODO: add inertias somehow?
        # self.motor_inertia = 0.1 # kg*m^2
        # self.diff_inertia = 0.1 # kg*m^2
        # self.driveline_inertias = np.array([0.1, 0.1, 0.1, 0.1]) # kg*m^2
        self.diff_efficiency = 1 # TODO: not used atm
        self.diff_fl = 0.607 # NOTE: Quaife parameter from Bens testing
        self.diff_preload = 5.2 # Nm - NOTE: Quaife parameter from Bens testing
        self.max_torque = 230 # Nm # NOTE: Emrax 228 peak torque
